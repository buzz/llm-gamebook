...
Enable real-time streaming of tool call events from the backend to the frontend via WebSocket, allowing the frontend to display pending tool calls and update them with results as they become available.
