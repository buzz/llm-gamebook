...
This capability enables the system to store and manage session-specific entity field overrides that persist across game sessions. Session state allows players to maintain progress and game state between interactions.
